        ...
        <div className="max-w-4xl mx-auto bg-black/40 p-8 rounded-xl backdrop-blur-sm border border-purple-900/50">
          <div className="text-left">
            ...
            <div className="prose prose-invert max-w-none text-gray-300">
              ...
              <p className="mb-4">
                If you have questions or comments about this Privacy Policy, please <a href="mailto:info@timeline-alchemy.com" className="text-purple-400 hover:text-purple-300 underline">contact via mail</a>.
              </p>
            </div>
          </div>
        </div>
