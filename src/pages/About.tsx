        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-lg p-8 mb-12 shadow-mystical">
            ...
            <p className="font-mystical text-lg text-muted-foreground mb-6 leading-relaxed">
              {currentLang === 'nl'
                ? 'Timeline Alchemy Studio is een unieke samenwerking tussen mens en kunstmatige intelligentie. Dennis en Antigravity (een geavanceerde AI-agent van Google DeepMind) werken dagelijks samen als een dynamisch duo.'
                : 'Timeline Alchemy Studio is a unique collaboration between human and artificial intelligence. Dennis and Antigravity (an advanced AI agent by Google DeepMind) work together daily as a dynamic duo.'}
            </p>
