            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-card/30 border border-border/30 rounded-2xl p-6 backdrop-blur-md">
                ...
                <div className="rounded-xl overflow-hidden border border-border/40 shadow-mystical relative group">
                  <img 
                    src="/images/slots-gameplay.png" 
                    alt="Cosmic Slots Gameplay Screenshot" 
                    className="w-full object-cover aspect-video group-hover:scale-102 transition-transform duration-500"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex items-end p-6">
                    <p className="text-sm text-gray-300">Intricate celestial slots with planets and constellations</p>
                  </div>
                </div>
              </div>
